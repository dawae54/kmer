...
class Kmer {
  public:
     ...
     * the kmer. It should be a string with at least one character. Input
     * parameter
     */
    ...
    /**
     * @brief Returns the position of a character to find in the text of
     * this Kmer. Query method
     * @param to_find the character to find in the text. Input parameter
     * @return the position of the found character. -1 if not found.
     */
    int find(char to_find) const;
    ...
    /**
     * @brief Returns the complementary of this Kmer. For example, given the
     * Kmer "TAGAC", the complementary is "ATCTG" (assuming that we use.
     ...
     * Query method
     * @param nucleotides A string with the list of possible nucleotides. Input
     * parameter
